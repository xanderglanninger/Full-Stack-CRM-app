...
const sendMail = (email) => {
  var transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'senproject384@gmail.com', // Your Gmail address
      pass: 'zbyz hqxs tutb iwpu'        // App password generated from Google
    }
  });
  ...
  var mailOptions = {
    ...
    text: 'Thank you for using our services. +/n +/n Please use the following link to leave a review our to raise a ticket: http://Localhost:5000/review'
  };
